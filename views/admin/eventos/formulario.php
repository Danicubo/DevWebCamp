<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <textarea class="formulario__input" name="descripcion" id="descripcion" placeholder="Descipción Evento" rows="8">
            <?php echo $evento->descripcion ?? '';  ?>
        </textarea>
    </div>

    <div class="formulario__campo">
        <label class="formulario__label" for="categoria">Descripción Evento</label>
        <select 
        name="categoria_id" 
        id="categoria"
...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        <label class="formulario__label" for="ponente">Ponentes</label>
        <input 
        type="text" 
        id="ponente"
        class="formulario__input"
